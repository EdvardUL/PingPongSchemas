...
const (
	PingService_Ping_FullMethodName = "/grpcPing.PingService/Ping"
)
...
func (c *pingServiceClient) Ping(ctx context.Context, in *PingMessage, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
func (UnimplementedPingServiceServer) Ping(context.Context, *PingMessage) (*Empty, error) {
...
var PingService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpcPing.PingService",
