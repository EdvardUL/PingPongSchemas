...
const (
	PongService_Pong_FullMethodName = "/grpcPong.PongService/Pong"
)
...
type PongServiceClient interface {
	Pong(ctx context.Context, in *PongMessage, opts ...grpc.CallOption) (*Empty, error)
}
...
func (c *pongServiceClient) Pong(ctx context.Context, in *PongMessage, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
type PongServiceServer interface {
	Pong(context.Context, *PongMessage) (*Empty, error)
...
func (UnimplementedPongServiceServer) Pong(context.Context, *PongMessage) (*Empty, error) {
...
func _PongService_Pong_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PongServiceServer).Pong(ctx, req.(*PongMessage))
	}
...
var PongService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "grpcPong.PongService",
